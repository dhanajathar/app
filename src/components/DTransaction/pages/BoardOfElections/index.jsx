/*
 * Component Name: Board Of Election
...
import { Autocomplete, FormControlLabel, TextField, Checkbox } from '@mui/material';
...
export default function BoardOfElections() {
  ...
  const sortedList = list => {
    ...
    const selectIndex = sortedList.findIndex(
      item => item === '--SELECT--' || item === 'ENGLISH' || item === 'BLACK'
    );
    if (selectIndex !== -1) {
  ...
  const validateFiled = (name, value) => {
    ...
    switch (name) {
      ...
      case 'otherParty':
        if (
          !value &&
          (formData.registerToVoteColumbia === 'YES' || formData.partyAffiliation !== 'Other')
        ) {
  ...
  return (
    <div className='d-container'>
      <form onSubmit={handleSubmit}>
        ...
        <div className='d-row'>
          ...
          <div className='col col-sm-12 col-md-4'>
            <Autocomplete
              ...
              disabled={
                formData.registerToVoteColumbia !== 'YES' ||
                (isFormDisabled && focusedField !== 'reasonForForm')
              }
          ...
          <div className='col col-sm-12 col-md-4'>
            <Autocomplete
              ...
              disabled={
                formData.registerToVoteColumbia !== 'YES' ||
                (isFormDisabled && focusedField !== 'language')
              }
        ...
        <div className='d-row'>
          <div className='col col-sm-12 col-md-4'>
            <Autocomplete
              ...
              disabled={
                formData.registerToVoteColumbia !== 'YES' ||
                (isFormDisabled && focusedField !== 'pollWorker')
              }
          ...
          <div className='col col-sm-12 col-md-4'>
            <Autocomplete
              ...
              disabled={
                formData.registerToVoteColumbia !== 'YES' ||
                (isFormDisabled && focusedField !== 'partyAffiliation')
              }
          ...
          {formData.partyAffiliation === 'OTHER' && (
            <div className='col col-sm-12 col-md-4'>
              <TextField
                fullWidth
                label='Other Party'
                ...
                disabled={
                  formData.registerToVoteColumbia !== 'YES' ||
                  (isFormDisabled && focusedField !== 'otherParty')
                }
        ...
        <div className='d-row'>
          ...
          <div className='col col-sm-12 col-md-4'>
            <Autocomplete
              ...
              disabled={
                formData.registerToVoteColumbia !== 'YES' ||
                (isFormDisabled && focusedField !== 'disableAssistanceRequired')
              }
          ...
          {formData.disableAssistanceRequired === 'YES' && (
            <div className='col col-sm-12 col-md-4'>
              <TextField
                fullWidth
                size='small'
        ...
        <div className='d-sub-title address-title'>
          {' '}
          Mailing Address Details{' '}
          <FormControlLabel
            className='last-address-checkbox'
            control={
              <Checkbox
                size='small'
                checked={copyData}
                disabled={formData.registerToVoteColumbia !== 'YES' || isFormDisabled}
                onChange={e => copyPrimaryAddress(e.target.checked)}
              />
            }
        ...
        <BOEAddress
          ...
          handleAddressChange={(name, value) => handleAddressChange(name, value, 'mailingAddress')}
          handleAddressError={(name, value) => handleAddressError(name, value, 'mailingAddress')}
        />
        <div className='d-sub-title address-title'>
          {' '}
          Last Address Details{' '}
          <FormControlLabel
            className='mailing-checkbox'
            disabled={!checkAllValues(formData.mailingAddress) || isFormDisabled}
            control={
              <Checkbox
                size='small'
                checked={copyMailingData}
                disabled={formData.registerToVoteColumbia !== 'YES' || isFormDisabled}
                onChange={e => copyMailingAddress(e.target.checked)}
              />
            }
        ...
        <BOEAddress
          ...
          disabledFields={formData.registerToVoteColumbia !== 'YES'}
          handleAddressChange={(name, value) => handleAddressChange(name, value, 'lastAddress')}
          handleAddressError={(name, value) => handleAddressError(name, value, 'lastAddress')}
        />
