...
const IndividualDetails = () => {
  ...
  const [otherInformationFrom, setOtherformationFrom] = useState({
    citizen: '',
    veteran: '',
  ...
  const [fristNameWarning, setFristNameWarning] = useState('');
  ...
  const truncation = value => {
    return (
      <FormGroup aria-label='position' row>
        <FormControlLabel
          control={<Checkbox tabIndex='-1' checked={value && value.length > 33} />}
          label='Truncated'
          labelPlacement='end'
        />
  ...
  const validateTransliterated = (input, value) => {
    if (input.isTransliterated) {
      return true;
    }
  ...
  const handleOtherInfoChange = e => {
    ...
    setOtherformationFrom(newValues);
    handleError(name, value);
  };

  const handleLangeChange = (name, value) => {
    const obj = {
      target: {
        name: name,
        value: value
  ...
  const handleNameChange = e => {
    ...
    const newValues = { ...personalInformationFrom };
    if (
      validateTransliterated(personalInformationFrom[name], value) &&
  ...
  const validateFiled = (name, value) => {
    ...
    switch (name) {
      ...
      case 'firstName':
        value && /\d/.test(value)
          ? setFristNameWarning('First Name contains numeric, please remove if not intentional')
          : setFristNameWarning('');
        break;
      case 'middleName':
        value && /\d/.test(value)
      ...
      case 'socialSecurityNumber':
        if (otherInformationFrom.socialSecurityNumber.trim() === '') {
          error = 'Invalid SSN';
        }
        if (
    ...
    <div className='d-container'>
        ...
        <div className='d-row truncation-row'>
          ...
          <div className='col col-md-4 col-sm-12'>
            <TextField
              ...
              name='firstName'
              fullWidth
              helperText={<DAlertBox warningText={fristNameWarning} />}
              label='First Name'
              inputProps={{ maxLength: 45 }}
              onChange={handleNameChange}
              onBlur={e => handleError(e.target.name, e.target.value)}
      ...
      <form onSubmit={e => handleSubmitFrom(e, otherInformationFrom)} noValidate autoComplete='off'>
        ...
        <div className='d-row'>
          <div className='col col-md-4 col-sm-12'>
            <TextField
              ...
              onBlur={() => {
                handleError('socialSecurityNumber', socialSecurityNumber);
                    ...
                    {socialSecurityNumber.replace(/-/g, '') !== '999999999' && (
                      <>
                        {socialSecurityNumber.replace(/-/g, '') === VerifiedSSN ? (
                          <div className='input-adornment-text verified-text'>
                            {' '}
                            &#10004; Verified{' '}
                          </div>
                        ) : (
          ...
          <div className='col col-md-4 col-sm-12'>
            <Autocomplete
              ...
              name='language'
              disabled={disabledOtherInfo}
              onChange={(e, value) => handleLangeChange('language', value)}
        ...
        <div className='d-row'>
          ...
          <div className='col col-md-2 col-sm-12'>
            <FormControl fullWidth>
              <InputLabel id='activeMiltary'>Active Military</InputLabel>
              <Select
                labelId='activeMiltary'
                id='activeMiltary'
                disabled={disabledOtherInfo}
