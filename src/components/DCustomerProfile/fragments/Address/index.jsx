          ...
          >
            ...
            >
              ...
              <div className='address-duration-wrapper'>
                <div className='customer-address-duration'>
                  {`${dayjs(address.fromDate).format('MM/DD/YYYY')} -  ${
            ...
            <AccordionDetails>
              <>
                ...
                {address?.residencyCertification && (
                  <>
                    {' '}
                    <div className='d-row'>
                      <div className='col col-sm-12 col-md-4'>
                    ...
                    {address.residencyCertification.isCertification === 'YES' && (
                      <>
                        <div className='d-sub-title'> Certifier Information</div>
                        <div className='d-row'>
                          <div className='col col-sm-12 col-md-8'>
                            <TextField
                              ...
                              disabled
                              defaultValue={
                                address.residencyCertification.certifiedInfo.certifierFullName
                              }
                          ...
                          <div className='col col-sm-12 col-md-4'>
                            <div className={'date-picker'}>
                              <TextField
                                ...
                                label='Date of Birth'
                                defaultValue={
                                  address.residencyCertification.certifiedInfo.dateOfBirth
                                }
                        ...
                        <div className='d-row'>
                          <div className='col col-sm-12 col-md-4'>
                            <TextField
                              ...
                              disabled
                              defaultValue={
                                address.residencyCertification.certifiedInfo.driverLicense
                              }
                          ...
                          <div className='col col-sm-12 col-md-4'>
                            <TextField
                              ...
                              defaultValue={
                                address.residencyCertification.certifiedInfo.expirationDate
                              }
                            >
                              {' '}
                            </TextField>
